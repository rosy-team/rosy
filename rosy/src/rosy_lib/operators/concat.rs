...
use crate::rosy_lib::{CD, DA, RE, ST, VE};
use anyhow::Result;
...
pub const CONCAT_REGISTRY: &[TypeRule] = &[
    TypeRule::with_comment(
        ...
        "1",
        "1",
        "Concatenate two Reals to a Vector",
    ),
    TypeRule::with_comment(
        "RE",
        "VE",
        ...
        "1",
        "1&2&3",
        "Prepend a Real to the left of a Vector",
    ),
    ...
    TypeRule::with_comment(
        ...
        "1&2",
        "3",
        "Append a Real to the right of a Vector",
    ),
    ...
    TypeRule::with_comment(
        ...
        "DA(1)",
        "DA(2)",
        "Concatenate two DAs to a DA vector",
    ),
    TypeRule::with_comment(
        "DA",
        "DA1",
        ...
        "DA(1)",
        "DA(1)&DA(2)",
        "Prepend a DA to the left of a DA vector",
    ),
    TypeRule::with_comment(
        "DA1",
        "DA",
        ...
        "DA(1)&DA(2)",
        "DA(3)",
        "Append a DA to the right of a DA vector",
    ),
    TypeRule::with_comment(
        "DA1",
        "DA1",
    ...
    TypeRule::with_comment(
        ...
        "CD(1)",
        "CD(2)",
        "Concatenate two CDs to a CD vector",
    ),
    TypeRule::with_comment(
        "CD",
        "CD1",
        ...
        "CD(1)",
        "CD(1)&CD(2)",
        "Prepend a CD to the left of a CD vector",
    ),
    TypeRule::with_comment(
        "CD1",
        "CD",
        ...
        "CD(1)&CD(2)",
        "CD(3)",
        "Append a CD to the right of a CD vector",
    ),
    TypeRule::with_comment(
        "CD1",
        "CD1",
...
pub fn get_return_type(lhs: &RosyType, rhs: &RosyType) -> Option<RosyType> {
    CONCAT_MAP
        .get_or_init(|| build_type_registry(CONCAT_REGISTRY))
        .get(&(*lhs, *rhs))
        .copied()
}
