...
//! ## Example
//! ```text
#![doc = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/tests/constructs/statements/da/dapep.rosy"))]
//! ```
...
impl Transpile for DapepStatement {
    fn transpile(
        ...
        let serialization = format!(
            "rosy_lib::core::dapew::rosy_dapep({}, rosy_as_u64(&({})), rosy_as_usize(&({})), {})?;",
...
impl TranspileableStatement for DapepStatement {
    fn wire_inference_edges(
        ...
        super::wire_da_result_cell(&self.result_expr, resolver, ctx, "DAPEP");
        Some(Ok(()))
    }
}
